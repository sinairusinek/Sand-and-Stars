...
(:
 ...
 :)
declare variable $config:default-template :="SandStarsSynoptic.html";
...
(:~
 ...
 :)
declare variable $config:default-odd :="SandNStars.odd";
...
(:~
 ...
 :)
declare variable $config:odd-available :=("SandNStars.odd");
